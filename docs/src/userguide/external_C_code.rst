...
Global Interpreter Lock (GIL) (:term:`our glossary<Global Interpreter Lock>`, `external documentation <https://docs.python.org/dev/glossary.html#term-global-interpreter-lock>`_).
