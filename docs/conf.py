...
latex_documents = [
    ("src/reference/index", "reference.tex", "Cython Reference Guide", _stdauthor, "manual"),
    ("src/tutorial/index", "tutorial.tex", "Cython Tutorial", _stdauthor, "manual"),
]
...
man_pages = [("index", "cython", "Cython Documentation", [authors], 1)]
...
texinfo_documents = [("index", "Cython", "Cython Documentation", authors, "Cython", "One line description of project.", "Miscellaneous")]
...
pdf_documents = [("index", project, project, authors.replace(", ", "\\\\"))]
