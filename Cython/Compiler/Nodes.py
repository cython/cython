...
utility_code_for_cimports = {
    ...
    'cpython.array'         : lambda context: UtilityCode.load_cached("ArrayAPI", "arrayarray.h"),
    'cpython.array.array'   : lambda context: UtilityCode.load_cached("ArrayAPI", "arrayarray.h"),
