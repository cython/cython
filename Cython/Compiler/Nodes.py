...
def embed_position(pos, docstring):
    if not Options.optionsInThread.embed_pos_in_docstring:
        return docstring
    ...
    def analyse_declarations(self, env, dest_scope=None):
        ...
        for declarator in self.declarators:
            ...
            if type.is_cfunction:
                ...
                if Options.optionsInThread.docstrings:
...
class CFuncDefNode(FuncDefNode):
    ...
    def declare_cpdef_wrapper(self, env):
        ...
        if (not self.entry.is_final_cmethod and
                (not env.is_module_scope or Options.optionsInThread.lookup_module_cpdef)):
            if self.override:
    ...
    def call_self_node(self, omit_optional_args=0, is_module_scope=0):
        ...
        skip_dispatch = not (is_module_scope and Options.optionsInThread.lookup_module_cpdef)
...
class DefNodeWrapper(FuncDefNode):
    ...
    def generate_function_header(self, code, with_pymethdef, proto_only=0):
        ...
        if (Options.optionsInThread.docstrings and entry.doc and
...
class PyClassDefNode(ClassDefNode):
    ...
    def __init__(self, pos, name, bases, doc, body, decorators=None,
        ...
        self.bases = bases
        from . import ExprNodes
        if self.doc and Options.optionsInThread.docstrings:
            doc = embed_position(self.pos, self.doc)
    ...
    def generate_type_ready_code(entry, code, bases_tuple_cname=None, check_heap_type_bases=False):
        ...
        # TODO: remove 'else:' and dedent
            ...
            for func in entry.type.scope.pyfunc_entries:
                ...
                if (func.is_special and Options.optionsInThread.docstrings and
