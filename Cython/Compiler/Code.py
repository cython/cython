...
class GlobalState:
    ...
    def generate_num_constants(self):
        ...
        if float_constants:
            ...
            define_constants(float_constants, start_offset=constant_offset)
