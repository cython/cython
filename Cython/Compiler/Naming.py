...
typeoffset_prefix = pyrex_prefix + "typeoffset_"
...
generator_obj_cname = generator_cname + "_obj"
...
outer_scope_obj_cname = outer_scope_cname + "_obj"
cur_scope_cname  = pyrex_prefix + "cur_scope"
cur_scope_obj_cname = cur_scope_cname + "_obj"
