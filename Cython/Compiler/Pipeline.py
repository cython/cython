...
def parse_stage_factory(context):
    def parse(compsrc):
        ...
        saved_cimport_from_pyx, Options.options_in_thread.cimport_from_pyx = Options.options_in_thread.cimport_from_pyx, False
        scope = context.find_module(full_module_name, pos = initial_pos, need_pxd = 0)
        Options.options_in_thread.cimport_from_pyx = saved_cimport_from_pyx
