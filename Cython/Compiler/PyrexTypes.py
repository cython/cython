...
class CFuncType(CType):
    ...
    def specialize(self, values):
        ...
        #        exception_value = None
        #    else:
        #        # Not explicitly set, so use the default for the return type.
        #        # (note that  for regular function types the exception values are
        #        # strings generated by going through ConstNode.get_constant_c_result_code)
        #        exception_value = str(return_type.exception_value)
