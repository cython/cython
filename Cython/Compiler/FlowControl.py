                            ...
                            if iterator.is_name:
                                ...
                                if iterator_type.is_builtin_type:
                                    ...
                                    self.mark_assignment(
                                        target.args[0],
                                        ExprNodes.IntNode(target.pos, value="PY_SSIZE_T_MAX", type=PyrexTypes.c_py_ssize_t_type),
                ...
                if not entry or entry.is_builtin:
                    if function.name in ("range", "xrange"):
                        ...
                        if len(sequence.args) > 2:
                            self.mark_assignment(
                                target,
                                self.constant_folder(ExprNodes.binop_node(node.pos, "+", sequence.args[0], sequence.args[2])),
                                rhs_scope=node.iterator.expr_scope,
                            )
