...
cdef extern from "Python.h":
    ...
    isize PyList_Size(object list) except -1
    # Return the length of the list object in list; this is equivalent
    # to "len(list)" on a list object.

    isize PyList_GET_SIZE(object list)
    # Macro form of PyList_Size() without error checking.

    PyObject* PyList_GetItem(object list, isize index) except NULL
    ...
    PyObject* PyList_GET_ITEM(object list, isize i)
    # Return value: Borrowed reference.
    # Macro form of PyList_GetItem() without error checking.

    i32 PyList_SetItem(object list, isize index, object item) except -1
    ...
    i32 PyList_Insert(object list, isize index, object item) except -1
    ...
    i32 PyList_Append(object list, object item) except -1
    # Append the object item at the end of list list. Return 0 if
    # successful; return -1 and set an exception if
    # unsuccessful. Analogous to list.append(item).

    list PyList_GetSlice(object list, isize low, isize high)
    ...
    i32 PyList_SetSlice(object list, isize low, isize high, object itemlist) except -1
    ...
    i32 PyList_Sort(object list) except -1
    # Sort the items of list in place. Return 0 on success, -1 on
    # failure. This is equivalent to "list.sort()".

    i32 PyList_Reverse(object list) except -1
