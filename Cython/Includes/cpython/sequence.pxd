...
extern from "Python.h":
    ...
    isize PySequence_Size(object o) except -1
    ...
    isize PySequence_Length(object o) except -1
    ...
    object PySequence_Repeat(object o, isize count)
    # Return value: New reference.
    ...
    object PySequence_InPlaceRepeat(object o, isize count)
    # Return value: New reference.
    # Return the result of repeating sequence object o count times, or
    ...
    object PySequence_GetItem(object o, isize i)
    # Return value: New reference.
    # Return the ith element of o, or NULL on failure. This is the
    # equivalent of the Python expression "o[i]".

    object PySequence_GetSlice(object o, isize i1, isize i2)
    # Return value: New reference.
    # Return the slice of sequence object o between i1 and i2, or NULL
    # on failure. This is the equivalent of the Python expression
    # "o[i1:i2]".

    i32 PySequence_SetItem(object o, isize i, object v) except -1
    ...
    i32 PySequence_DelItem(object o, isize i) except -1
    # Delete the ith element of object o. Returns -1 on failure. This
    # is the equivalent of the Python statement "del o[i]".

    i32 PySequence_SetSlice(object o, isize i1, isize i2, object v) except -1
    # Assign the sequence object v to the slice in sequence object o
    # from i1 to i2. This is the equivalent of the Python statement
    # "o[i1:i2] = v".

    i32 PySequence_DelSlice(object o, isize i1, isize i2) except -1
    # Delete the slice in sequence object o from i1 to i2. Returns -1
    # on failure. This is the equivalent of the Python statement "del
    # o[i1:i2]".

    i32 PySequence_Count(object o, object value) except -1
    ...
    i32 PySequence_Contains(object o, object value) except -1
    # Determine if o contains value. If an item in o is equal to
    # value, return 1, otherwise return 0. On error, return -1. This
    # is equivalent to the Python expression "value in o".

    isize PySequence_Index(object o, object value) except -1
    ...
    PyObject* PySequence_Fast_GET_ITEM(object o, isize i)
    ...
    object PySequence_ITEM(object o, isize i)
    # Return value: New reference.
    ...
    isize PySequence_Fast_GET_SIZE(object o)
