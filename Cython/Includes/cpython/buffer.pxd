...
cdef extern from "Python.h":
    ...
    i32 PyObject_GetBuffer(object obj, Py_buffer *view, i32 flags) except -1
    ...
    void* PyBuffer_GetPointer(Py_buffer *view, isize *indices)
    # ??

    isize PyBuffer_SizeFromFormat(char *) # actually const char
    # Return the implied ~Py_buffer.itemsize from the struct-stype
    # ~Py_buffer.format

    i32 PyBuffer_ToContiguous(void *buf, Py_buffer *view, isize len, char fort)
    # ??

    i32 PyBuffer_FromContiguous(Py_buffer *view, void *buf, isize len, char fort)
    # ??

    i32 PyObject_CopyToObject(object obj, void *buf, isize len, char fortran) except -1
    ...
    i32 PyObject_CopyData(object dest, object src) except -1
    ...
    void PyBuffer_FillContiguousStrides(i32 ndims,
                                        isize *shape,
                                        isize *strides,
                                        isize itemsize,
                                        char fort)
    ...
    i32 PyBuffer_FillInfo(Py_buffer *view, object exporter, void *buf,
