...
cdef extern from "Python.h":
    ...
    bytearray PyByteArray_FromStringAndSize(char *string, isize len)
    ...
    isize PyByteArray_Size(object bytearray)
    ...
    i32 PyByteArray_Resize(object bytearray, isize len)
    # Resize the internal buffer of bytearray to len.

    char* PyByteArray_AS_STRING(object bytearray)
    # Macro version of PyByteArray_AsString().

    isize PyByteArray_GET_SIZE(object bytearray)
