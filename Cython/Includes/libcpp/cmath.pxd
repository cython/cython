...
cdef extern from "<cmath>" namespace "std" nogil:
    ...
    bint isfinite(long double x)
    
    bint isinf(float x)
    bint isinf(double x)
    bint isinf(long double x)
    
    bint isnan(float x)
    bint isnan(double x)
    bint isnan(long double x)
    
    bint isnormal(float x)
    bint isnormal(double x)
    bint isnormal(long double x)
    
    bint signbit(float x)
    bint signbit(double x)
    bint signbit(long double x)
    
    bint isgreater(float x, float y)
    bint isgreater(double x, double y)
    bint isgreater(long double x, long double y)
    
    bint isgreaterequal(float x, float y)
    bint isgreaterequal(double x, double y)
    bint isgreaterequal(long double x, long double y)
    
    bint isless(float x, float y)
    bint isless(double x, double y)
    bint isless(long double x, long double y)
    
    bint islessequal(float x, float y)
    bint islessequal(double x, double y)
    bint islessequal(long double x, long double y)
    
    bint islessgreater(float x, float y)
    bint islessgreater(double x, double y)
    bint islessgreater(long double x, long double y)
    
    bint isunordered(float x, float y)
    bint isunordered(double x, double y)
    bint isunordered(long double x, long double y)
