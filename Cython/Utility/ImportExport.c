...
static int ${import_star}(PyObject* m) {
    ...
    for (Py_ssize_t i=0; i<size; i++) {
        ...
        if (${import_star_set}(mstate, item, name) < 0) goto bad;
    }
    ret = 0;
...
static PyObject* __Pyx__TryImportNumPyArray(void); /* proto - not the "public" interface to this utility code */

/////////////// ImportNumPyArray ///////////////
//@requires: ImportExport.c::Import
//@requires: Exceptions.c::IgnoreException
//@requires: Synchronization.c::GetLazyCachedObject{"guard": 1, "object_cname": "__pyx_numpy_ndarray", "maker_cname": "__Pyx__TryImportNumPyArray", "getter_cname": "__Pyx__ImportNumPyArrayTypeIfAvailable"}

static PyObject* __Pyx__TryImportNumPyArray(void) {
...
static CYTHON_INLINE PyObject* __Pyx_ImportNumPyArrayTypeIfAvailable(void) {
    // Function generated by GetLazyCachedObject utility code.
