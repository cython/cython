...
#define __PYX_LIMITED_VERSION_HEX PY_VERSION_HEX
  ...
  #define CYTHON_FAST_GIL 0
    ...
    #define CYTHON_VECTORCALL_NEW (PYPY_VERSION_NUM >= 0x07030800 && CYTHON_VECTORCALL)
  #endif
  #ifndef CYTHON_PEP487_INIT_SUBCLASS
    #define CYTHON_PEP487_INIT_SUBCLASS 1
  #endif
  ...
  #ifndef CYTHON_VECTORCALL_NEW
    #define CYTHON_VECTORCALL_NEW (CYTHON_VECTORCALL && __PYX_LIMITED_VERSION_HEX >= 0x030E0000)
  #endif
  #ifndef CYTHON_PEP487_INIT_SUBCLASS
    #define CYTHON_PEP487_INIT_SUBCLASS 1
  #endif
