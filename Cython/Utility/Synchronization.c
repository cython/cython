...
// * maker_cname - the name of a prexisting function used to generate an owned reference to
//                          an object
//
...
// However we will always return the result from the first successsful completion of the maker
// function.
