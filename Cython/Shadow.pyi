from builtins import int as py_int, float as py_float, bool as py_bool, str as py_str, complex as py_complex
from typing import Union, Dict, Any, Sequence, Optional, List, TypeVar, Type, Generic
...
class _ArrayType(object, Generic[_T]):
    ...
    def __init__(
        self, dtype: _T, ndim: int, is_c_contig: bool = ..., is_f_contig: bool = ..., inner_contig: bool = ..., broadcasting: Any = ...
    ) -> None: ...
...
class PointerType(CythonType, Generic[_T]):
    def __init__(self, value: Optional[Union[ArrayType[_T], PointerType[_T], List[_T], int]] = ...) -> None: ...
...
def index_type(base_type: _T, item: Union[tuple, slice, int]) -> _ArrayType[_T]: ...
