...
class ReferenceType(PointerType[_T]):
    """C++ lvalue reference type."""

class RValueReferenceType(ReferenceType[_T]):
...
class reference(ReferenceType[_T]):
    def __new__(cls, basetype: _T) -> Type[ReferenceType[_T]]: ...
    def __class_getitem__(cls, basetype: _T) -> Type[ReferenceType[_T]]: ...

class rvalue_reference(RValueReferenceType[_T]):
    def __new__(cls, basetype: _T) -> Type[RValueReferenceType[_T]]: ...
    def __class_getitem__(cls, basetype: _T) -> Type[RValueReferenceType[_T]]: ...
