...
def accept_ArithmeticError(exc: ArithmeticError):
    ...
    inferred_subtypes_var = (
        FloatingPointError('message')
        if exc else OverflowError('message')
        if exc else ZeroDivisionError('message')
    )
...
def accept_BaseException(exc: BaseException):
    ...
    inferred_subtypes_var = (
        Exception('message')
        if exc else GeneratorExit('message')
        if exc else KeyboardInterrupt('message')
        if exc else SystemExit('message')
        if exc else ArithmeticError('message')
        if exc else AssertionError('message')
        if exc else AttributeError('message')
        if exc else BufferError('message')
        if exc else EOFError('message')
        if exc else ImportError('message')
        if exc else LookupError('message')
        if exc else MemoryError('message')
        if exc else NameError('message')
        if exc else OSError('message')
        if exc else ReferenceError('message')
        if exc else RuntimeError('message')
        if exc else StopAsyncIteration('message')
        if exc else StopIteration('message')
        if exc else SyntaxError('message')
        if exc else SystemError('message')
        if exc else TypeError('message')
        if exc else ValueError('message')
        if exc else Warning('message')
        if exc else FloatingPointError('message')
        if exc else OverflowError('message')
        if exc else ZeroDivisionError('message')
        if exc else BytesWarning('message')
        if exc else DeprecationWarning('message')
        if exc else FutureWarning('message')
        if exc else ImportWarning('message')
        if exc else PendingDeprecationWarning('message')
        if exc else ResourceWarning('message')
        if exc else RuntimeWarning('message')
        if exc else SyntaxWarning('message')
        if exc else UnicodeWarning('message')
        if exc else UserWarning('message')
        if exc else BlockingIOError('message')
        if exc else ChildProcessError('message')
        if exc else ConnectionError('message')
        if exc else FileExistsError('message')
        if exc else FileNotFoundError('message')
        if exc else InterruptedError('message')
        if exc else IsADirectoryError('message')
        if exc else NotADirectoryError('message')
        if exc else PermissionError('message')
        if exc else ProcessLookupError('message')
        if exc else TimeoutError('message')
        if exc else IndentationError('message')
        if exc else IndexError('message')
        if exc else KeyError('message')
        if exc else ModuleNotFoundError('message')
        if exc else NotImplementedError('message')
        if exc else RecursionError('message')
        if exc else UnboundLocalError('message')
        if exc else UnicodeError('message')
        if exc else BrokenPipeError('message')
        if exc else ConnectionAbortedError('message')
        if exc else ConnectionRefusedError('message')
        if exc else ConnectionResetError('message')
        if exc else TabError('message')
        if exc else EnvironmentError('message')
        if exc else IOError('message')
    )
