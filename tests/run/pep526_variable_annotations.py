...
def test_tuple(a: typing.Tuple[cython.int, cython.float], b: typing.Tuple[cython.int, ...], c: Tuple[cython.int, object]):  # cannot be a ctuple
    """
...
def test_use_typing_attributes_as_non_annotations():
    ...
    allowed_optional_strings = ["typing.Union[typing.Dict, NoneType]", "typing.Optional[typing.Dict]"]
    print(x1, x2)
