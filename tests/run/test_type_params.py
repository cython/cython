...
# Modified slightly from CPython.
# It's almost entirely a compile-only test here since Cython doesn't actually
# handle this feature and so almost all tests are disabled
# (mostly just by removing the unittest.TestCase base class).
...
class TypeParamsInvalidTest(unittest.TestCase):
    ...
    def _test_name_non_collision_02(self):
    ...
    def _test_name_non_collision_03(self):
        ns = run_code("""def func[A](*A): return A""")
        func = ns["func"]
        self.assertEqual(func(1), (1,))
        A, = func.__type_params__
    ...
    def _test_name_non_collision_04(self):
    ...
    def _test_name_non_collision_05(self):
        ns = run_code("""
            class ClassA:
    ...
    def _test_name_non_collision_06(self):
        ns = run_code("""
            class ClassA[X]:
    ...
    def _test_name_non_collision_07(self):
        ns = run_code("""
            class ClassA[X]:
                def func(self):
                    X = 1
    ...
    def _test_name_non_collision_08(self):
        ns = run_code("""
            class ClassA[X]:
                def func(self):
    ...
    def _test_name_non_collision_9(self):
        ns = run_code("""
            class ClassA[X]:
                def func[X](self):
                    ...
    ...
    def _test_name_non_collision_10(self):
        ns = run_code("""
            class ClassA[X]:
                X: int
            """
    ...
    def _test_name_non_collision_13(self):
        ns = run_code("""
            X = 1
            def outer():
                def inner[X]():
    ...
    def _test_incorrect_mro_explicit_object(self):
...
class TypeParamsTypeVarTupleTest(unittest.TestCase):
    ...
    def _test_typevartuple_02(self):
        def func1[*A]():
            return A
...
class DefaultsTest:  # (unittest.TestCase):
    def _test_defaults_on_func(self):
        ns = run_code("""
    ...
    def _test_defaults_on_class(self):
        ns = run_code("""
    ...
    def _test_defaults_on_type_alias(self):
        ns = run_code("""
    ...
    def _test_starred_typevartuple(self):
        ns = run_code("""
    ...
    def _test_lazy_evaluation(self):
        ns = run_code("""
    ...
    def _test_symtable_key_regression_default(self):
    ...
    def _test_symtable_key_regression_name(self):
