...
@cython.test_assert_path_exists(
    "//PrimaryCmpNode",
    "//PrimaryCmpNode[@special_bool_cmp_function]",
)
...
@cython.test_fail_if_path_exists(
    "//CascadedCmpNode[not(@special_bool_cmp_function)]",
    "//PrimaryCmpNode[not(@special_bool_cmp_function)]",
)
...
@cython.test_assert_path_exists(
    "//PrimaryCmpNode",
    "//PrimaryCmpNode[@special_bool_cmp_function]",
    "//CascadedCmpNode[@special_bool_cmp_function]",
)
@cython.test_fail_if_path_exists(
    "//CascadedCmpNode[not(@special_bool_cmp_function)]",
    "//PrimaryCmpNode[not(@special_bool_cmp_function)]",
