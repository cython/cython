...
18:7: 'cython.floating' is not a valid cython.* module. 'floating' is not a module but is accessible within the 'cython' module. Did you mean 'from cython cimport floating' or just 'cimport cython'?
19:7: 'cython.cfunc' is not a valid cython.* module. 'cfunc' is not a module but is accessible within the 'cython' module. Did you mean 'from cython cimport cfunc' or just 'cimport cython'?
"""
