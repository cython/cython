...
skip_tests = frozenset({
    ...
    ('TestHash', 'test_unsafe_hash'),  # not sure if it's a bug or just a difference in how the hash is calculated
    ('TestHash', 'test_1_field_hash'),  # not sure if it's a bug or just a difference in how the hash is calculated
    ('TestHash', 'test_0_field_hash'),  # not sure if it's a bug or just a difference in how the hash is calculated
